...
export HISTIGNORE="his:history:history *:pwd:df:ls:ls -la:ll:dir:gsta:glog:graph:gadd:game:usong *:u *:*:cd *:exit" # these commands won't be logged, delimeted by colon
